...
describe Work do
  ...
  describe "validations" do
    ...
    it "requires a title" do
      work = Work.new(category: 'album', user_id: users(:kari).id)
      work.valid?.must_equal false
  ...
  describe "vote_count" do
    ...
    it "tracks the number of votes" do
      work = Work.create!(title: "test title", category: "movie", user_id: users(:kari).id)
      4.times do |i|
        user = User.create!(username: "user#{i}", uid: i*4, provider: "facebook")
  ...
  describe "top_ten" do
    before do
      ...
      test_users = []
      20.times do |i|
        test_users << User.create!(username: "user#{i}", uid: i*5, provider: "google")
      end
